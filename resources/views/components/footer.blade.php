    ...
    <div class="w-full container mx-auto flex-row flex-wrap flex pt-4">
        <div class="w-full md:w-2/3">
            <h4 class="font-title text-2xl md:text-4xl mb-12 text-white font-medium leading-tight tracking-wide">Amplifiying your voice.</h4>
                ...
                <div class="w-full flex flex-row text-light-green text-xl md:text-2xl pt-8 md:pt-16 pb-8 md:pb-16">
        ...
        <div class="w-full md:w-1/3 flex flex-row flex-wrap  ">
            ...
            <div class="w-full mt-8 mb-12">
                <p class="text-white text-base md:text-xl">Join our community.</p>
                <div class="w-full pt-4 flex items-center">
                    <input type="text" class="border-2 flex-1 border-white rounded-md text-base md:text-lg p-2 md:p-3 h-12 md:h-14 bg-dark-grey text-white placeholder-white " placeholder="Your email">
                    <button class="ml-2 rounded-md bg-light-green px-3 py-2 md:px-5 md:py-3 h-12 md:h-14 text-dark-grey font-bold text-sm md:text-lg">Subscribe</button>
                </div>
            </div>
        </div>
