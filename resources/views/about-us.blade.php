        ...
        <div class="bg-green relative flex flex-col w-full">
            ...
            <x-header-one>
                ...
                <x-slot name="body">
                    ...
                    <p class="text-white text-lg md:text-xl w-full mb-12">Historically, companies have managed to be commercially successful without truly committing to diversity. It’s never been a priority because it hasn’t affected their bottom line.</p>
                    <p class="text-white text-lg md:text-xl w-full mb-12">At inside voices, our mission is to <span class="underline">change the incentive structure</span>, so that companies need to embrace diversity, equity and inclusion (DEI) in order to be successful.</p>
                    <p class="text-white text-lg md:text-xl w-full mb-12">By providing transparency, we can celebrate the champions, and force companies with toxic cultures to reform.</p>
