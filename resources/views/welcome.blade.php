    ...
    <body class="antialiased font-sans font-light">
        ...
        <div class="bg-green relative flex flex-col w-full">
            ...
            <x-header-one>
                ...
                <x-slot name="body">
                    <p class="text-white text-lg md:text-xl w-full xl:w-5/6 mb-12">Hold your employer accountable by anonymously sharing how they <strong>really</strong> perform on diversity, equity and inclusion.</p>
